...
namespace WorkManagementSystem.Migrations
{
    ...
    [Migration("20260709114034_ProductivityProjectBoardUpgrade")]
    partial class ProductivityProjectBoardUpgrade
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WorkManagementSystem.Domain.Entities.Board", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("WorkManagementSystem.Domain.Entities.BoardColumn", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WorkManagementSystem.Domain.Entities.TaskActivity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WorkManagementSystem.Domain.Entities.TaskItem", b =>
                {
                    ...
                    b.ToTable("Tasks", t =>
                        {
                            t.HasCheckConstraint("CK_Tasks_Hours_NonNegative", "[EstimatedHours] >= 0 AND [ActualHours] >= 0");
                        });
                });

            modelBuilder.Entity("WorkManagementSystem.Domain.Entities.TaskReminder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WorkManagementSystem.Domain.Entities.BoardColumn", b =>
                {
                    b.HasOne("WorkManagementSystem.Domain.Entities.Board", "Board")
                        .WithMany()
            ...
            modelBuilder.Entity("WorkManagementSystem.Domain.Entities.TaskItem", b =>
                {
                    ...
                    b.HasOne("WorkManagementSystem.Domain.Entities.BoardColumn", "Column")
                        .WithMany()
