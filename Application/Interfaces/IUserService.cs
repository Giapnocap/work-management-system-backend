...
namespace WorkManagementSystem.Application.Interfaces
{
    public interface IUserService
    {
        ...
        Task<List<UserDto>> GetVisibleUsers(Guid requesterId, CancellationToken cancellationToken = default);
        Task<List<UserDto>> SearchVisibleUsers(Guid requesterId, string keyword, string? role, Guid? unitId, CancellationToken cancellationToken = default);
        ...
        Task<PerformanceDto> GetVisiblePerformanceAsync(Guid requesterId, Guid targetUserId, Guid? periodId = null, CancellationToken cancellationToken = default);
